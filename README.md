...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/key-protect/ibm/latest)
...
<ul>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-key-protect/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-key-protect/tree/main/examples/advanced">Advanced private example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-key-protect/tree/main/examples/basic">Basic example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-key-protect/tree/main/examples/dedicated">Dedicated example</a>
...
| <a name="input_dedicated_master_key_keyname"></a> [dedicated\_master\_key\_keyname](#input\_dedicated\_master\_key\_keyname) | The name of the master key used to initialize the dedicated Key Protect instance. Must be 8 characters or less. Only used when `plan` is `dedicated`. | `string` | `"mbkkey"` | no |
| <a name="input_dedicated_master_key_share_1_filepath"></a> [dedicated\_master\_key\_share\_1\_filepath](#input\_dedicated\_master\_key\_share\_1\_filepath) | Filepath for key share 1 of the master key used to initialize the dedicated Key Protect instance. Only used when `plan` is `dedicated`. | `string` | `"kp-dedicated-mbk-1.key"` | no |
| <a name="input_dedicated_master_key_share_1_passphrase"></a> [dedicated\_master\_key\_share\_1\_passphrase](#input\_dedicated\_master\_key\_share\_1\_passphrase) | Passphrase for key share 1 of the master key used to initialize the dedicated Key Protect instance. Only used when `plan` is `dedicated`. | `string` | `""` | no |
| <a name="input_dedicated_master_key_share_2_filepath"></a> [dedicated\_master\_key\_share\_2\_filepath](#input\_dedicated\_master\_key\_share\_2\_filepath) | Filepath for key share 2 of the master key used to initialize the dedicated Key Protect instance. Only used when `plan` is `dedicated`. | `string` | `"kp-dedicated-mbk-2.key"` | no |
| <a name="input_dedicated_master_key_share_2_passphrase"></a> [dedicated\_master\_key\_share\_2\_passphrase](#input\_dedicated\_master\_key\_share\_2\_passphrase) | Passphrase for key share 2 of the master key used to initialize the dedicated Key Protect instance. Only used when `plan` is `dedicated`. | `string` | `""` | no |
| <a name="input_dedicated_master_key_share_3_filepath"></a> [dedicated\_master\_key\_share\_3\_filepath](#input\_dedicated\_master\_key\_share\_3\_filepath) | Filepath for key share 3 of the master key used to initialize the dedicated Key Protect instance. Only used when `dedicated_crypto_units` is 3. Only used when `plan` is `dedicated`. | `string` | `null` | no |
| <a name="input_dedicated_master_key_share_3_passphrase"></a> [dedicated\_master\_key\_share\_3\_passphrase](#input\_dedicated\_master\_key\_share\_3\_passphrase) | Passphrase for key share 3 of the master key used to initialize the dedicated Key Protect instance. Only used when `dedicated_crypto_units` is 3. Only used when `plan` is `dedicated`. | `string` | `null` | no |
| <a name="input_dedicated_signature_key_filepath"></a> [dedicated\_signature\_key\_filepath](#input\_dedicated\_signature\_key\_filepath) | Filepath for the signature key used to initialize the dedicated Key Protect instance. The file is created if it does not exist. Only used when `plan` is `dedicated`. | `string` | `"kp-dedicated-signature.key"` | no |
| <a name="input_dedicated_signature_key_owner"></a> [dedicated\_signature\_key\_owner](#input\_dedicated\_signature\_key\_owner) | Owner label for the signature key used to initialize the dedicated Key Protect instance. Only used when `plan` is `dedicated`. | `string` | `"ADMIN"` | no |
| <a name="input_dedicated_signature_key_passphrase"></a> [dedicated\_signature\_key\_passphrase](#input\_dedicated\_signature\_key\_passphrase) | Passphrase for the signature key used to initialize the dedicated Key Protect instance. Only used when `plan` is `dedicated`. | `string` | `""` | no |
...
| <a name="input_resource_tags"></a> [resource\_tags](#input\_resource\_tags) | Add user resource tags to the Key Protect instance to organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types). | `list(string)` | `[]` | no |
